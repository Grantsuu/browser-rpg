...
import { getBounties, getCharacter, getCharacterCombatStats, getCharacterLevels, getCharacterInventory } from './apiClient';
...
export const useCharacterBounties = () => useQuery({
    queryKey: ['characterBounties'],
    queryFn: getBounties
});